				...
				<table class="table table-condensed">
					...
					<c:forEach items="${allGoods}" var="goods">
						<tr>
							...
							<td class="text-left"><a href="<%=GOODS_SHOW_URL%>?gid=${goods.gid}" title="查看商品详情"><span id="name-${goods.gid}">${goods.name}</span>${goods.name}</a></td>
							...
							<td class="text-center"><span id="lastin-${goods.gid}"></span>${goods.lastin}</td>
